...
import { BankingAnalytic } from './banking-analytic';
...
const TABLE_HEAD = [
  ...
  { id: 'price', label: 'Numero Déclaration' },
  { id: 'price', label: 'Montant' },
  { id: 'price', label: 'Type Déclaration' },
    ...
    <>
      <DashboardContent maxWidth="xl">
        <CustomBreadcrumbs
          ...
          links={[
            { name: 'Facturations', href: paths.dashboard.root },
            { name: 'Factures', href: paths.dashboard.invoice.root },
